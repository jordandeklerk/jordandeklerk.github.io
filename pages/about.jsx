        ...
        <div className={styles.introContent}>
          ...
          <div className={styles.introText}>
            ...
            <p className={styles.introParagraph}>
              Hi, I'm Jordan. I'm a Senior Data Scientist at DICK's Sporting Goods on the media and marketing science team currently working on hierarchical Bayesian media mix modeling and deep learning for retail media.
            </p>
            <p className={styles.introParagraph}>
